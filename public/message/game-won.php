...
<body class="introduction">            
    ...
    <script>
        ...
        btnHome.addEventListener('click', function() {
            ...
            // Close the popup
            window.opener.location.href = '/dw3/finalproject/index.php';
            window.close();
        });

        btnTryAgain.addEventListener('click', function() {
            // Redirect the parent window to the save page
            window.opener.location.href = '/dw3/finalproject/public/form/game-form.php';
            // Close the popup
            window.close();
        });
        ...
        btnHistory.addEventListener('click', function() {
            // Redirect the parent window to the save page
            window.opener.location.href = '/dw3/finalproject/public/message/history-table.php';
            // Close the popup
            window.close();
        });
